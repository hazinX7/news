...
Веб-приложение новостного портала на FastAPI.
...
При старте выполняется SQL-скрипт `db/init/001_schema_seed.sql`: он создает таблицы и заполняет БД тестовыми пользователями, новостями, комментариями и реакциями.
